	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www25.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
				...
				if (open_mini_windown == '1' && "jh" == 'www111'){//品房阁需求 处理
					...
					if (last_invite_kf != '') {
						...
						try{
							...
							document.getElementById('iframe_company_mini').contentWindow.postMessage(lnk_msg,"https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013");
						}catch(e){}
				}
					return;
				}
	...
	//	var acc_poptype				= -1;
		...
		if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			...
			Inv.prototype = {
				...
				talk : function(){
					...
					if (zdfq_type == 3) {
						...
						var openurl = "https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013&tfrom=2" + force_kf;
						onliner_zdfq=2;
			...
			if(0 == 1){
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www25.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www25.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www25.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www25.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
			}else {
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www25.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www25.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www25.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www25.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
			}
			...
			if(mini_style_type==1){
				bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
									...
									'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www25.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www25.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
								'</div>';
			...
			tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
								'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 10px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
									'<img style="max-width: 80px;width:auto;height:24px;float: left;margin-top: 6px;border-radius:2px;" src="https://www25.53kf.com/img/upload/10174963/mobile/temp/mobile_53kf_1531556560.jpg"/>'+
	...
	function show_floatWindow(type){//type:  zdfq:主动发起规则打开  qzzk:强制展开打开   不传:用户点击展开
		...
		try{
			...
			if (navigator.userAgent.indexOf("Firefox") > -1){
				document.getElementById('iframe_company_mini').contentWindow.postMessage('openMini',"https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013&tfrom=2");
			}
	...
	function cgpic(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
		}

	}
	function cgpic2(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
		}
	}
	function cgpic3(t){
		document.querySelector('.mini_maxto').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
	}
	function cgpic4(t){
		document.querySelector('.mini_maxto').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
	}
	function cgpic5(t){
		document.querySelector('.mini_close').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
	}
	function cgpic6(t){
		document.querySelector('.mini_close').style.background="url('https://www25.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
	}
	...
	function max_min_company_mini(t)
	{
		if (t.getAttribute('max_min') == 'max')
		{
			...
			t.style.backgroundImage = "url('https://www25.53kf.com/style/chat/minichat2/img/max.png')";
			t.setAttribute('max_min','min');
			t.title = t.getAttribute('mini_recover');
			$53("div_company_mini").style.right = '0px';
			$53("div_company_mini").style.bottom = '0px';			$53("mini_header_bg_div").style.backgroundImage = "url('https://www25.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
		}
		else
		{
			...
			t.style.backgroundImage = "url('https://www25.53kf.com/style/chat/minichat2/img/min.png')";
		...
		}		$53("mini_header_bg_div").style.backgroundImage = "url('https://www25.53kf.com/style/chat/minichat2/img/header_bg_1.png')";
	}
	// 定时调用判断是否显示邀请框
	...
	{
		if(zdfq_switch == 'yes') {
			//document.cookie = "onliner_zdfq72174963="+onliner_zdfq;
			document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
		} else {
			document.cookie = "my_acc_reauto_time=null;path=/";
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function get_location(type,invite_kf){
		...
		try{
			...
			if(type==1){
				...
				var open_mini_windown = $53("iframe_company_mini").getAttribute("open_mini_windown");
				if (open_mini_windown == '1' && "jh" == 'www111'){//品房阁需求 处理
					$53.createScript("hz6d_send_lnk_debug0", hz6d_alias_host+"/wnn_debug.php?cmd=senlnk0&hz6d_guest_ip="+hz6d_guest_ip+"&hz6d_guest_id="+hz6d_guest_id+"&force_kf="+force_kf+"&last_force_kf="+last_invite_kf);
					if (last_invite_kf != '') {
						acc_get_force = true;
						var lnk_msg = 'sendLNK{#53#}'+last_invite_kf;
						try{
	...
	function close_company_mini(){
		...
		// if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72174963="+onliner_zdfq;}
	...
	function ivt_seturl(zdy_yqk)
	{
		var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
			...
			if(vals[1])
			{
				...
				{
					case 'KF':
						var click_open_url = 'window.open(\"https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
						...
						break;
						//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www25.53kf.com/webCompany.php?kf_sign=DI3MTMTYwMU5NzEwNDU1MDU4MzU4MDEzNzIxNzQ5NjM=&arg=10174963&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fcymooc.org%2FindexPage_IndexPage_index_Index&keyword=&brief=&logo=&question=&uid=85876ee95df0b3fa1f5d3071a60ac946&guest_id=10455058358013&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
					case 'CLOSE':
						click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
					case 'ETEL':
						click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72174963&style_id=106232985\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
					case 'QQ':
						if(valst[1]){
							if(valst[1].toLowerCase().indexOf('biz') > -1){
								var qq = valst[1].replace('biz','');
								link_str = 'https://www25.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
							}else{
