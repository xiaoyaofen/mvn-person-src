!function (t, a, e, i) {
    ...
    n.prototype = {
        init: function () {
            ...
            var t = this.opts, a = this.current, e = t.totalPage, i = this.getPagesTpl();
            ...
            var t = this.opts, a = t.totalPage, e = this.current,n=t.count;
            if(a<=n){
            ...
            var t = this.opts, a = t.totalPage, e = this.current, i = "", n = t.count;//a总页数e当前 n显示页数
            if (a <= n)for (g = 1; g <= a; g++)
                i += g === e ? '<a href="javascript:void(0);" class="ui-pagination-page-item active" data-current="' + g + '">' + g + "</a>" : '<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="' + g + '">' + g + "</a>"; else {
                var s = n / 2;
                if (e <= s)for (g = 1; g <= n; g++)i += g === e ? '<a href="javascript:void(0);" class="ui-pagination-page-item active" data-current="' + g + '">' + g + "</a>" : '<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="' + g + '">' + g + "</a>"; else {
                    var r = Math.floor(s), c = e + r, h = e - r, o = n % 2 == 0;
...
var sssss="sssssssssssbbbbbbbbbbb";